      ...
      <div class="q-gutter-md flex flex-center">
        <q-card>
          <q-card-section class="text-center">
            ...
            <q-radio v-model="preset" val="random" label="Random Emoji" />
          </q-card-section>
        </q-card>
        <q-card>
          <q-card-section class="text-center">
      ...
      <div class="q-ma-md column flex-center" v-if="preset === 'custom'">
        ...
        <div class="row flex-center" style="width: 288px">
          <q-input
            ...
            v-model="items[key]"
            maxlength="2"
            style="width: 96px; font-size: 32px"
          >
